...
//    implementation(platform("io.opentelemetry:opentelemetry-bom:1.6.0"))
    implementation("io.opentelemetry:opentelemetry-sdk-extension-resources:1.6.0")
    ...
    implementation("io.opentelemetry:opentelemetry-exporter-zipkin:1.6.0")
    implementation("io.opentelemetry:opentelemetry-exporter-otlp-trace:1.6.0")
